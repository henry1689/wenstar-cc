...
const NON_NAME_TAIL_CHARS = new Set([
  ...
  // 2026-09-11 三轮扩充（批次1 实体门控）—— 实测 9 个滑窗垃圾被建档为 person：
  //   关心/高峰电/计雷灵/文气/方情绪/终给人/常漂亮/路轻盈/常多情（TXS-154~162）
  //   下列尾字满足「从未出现在 35 个真实人名/别名中、且汉人名极少以此收尾」，为安全增量：
  //   电（高峰电）· 气（文气）· 绪（方情绪）· 人（终给人）
  //   ⚠️ 刻意排除：心（心怡/静心）· 亮（明亮/光亮）· 盈（盈盈）· 灵（都灵/灵灵）
  //     —— 这四个是常见人名用字，纳入会误伤未来真人（宁可漏拦，不可误伤）。
  '电','气','绪','人',
]);
